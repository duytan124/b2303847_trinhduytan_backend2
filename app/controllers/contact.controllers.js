...
exports.create = async (req, res, next) => {
  ...
  try {
    ...
    return next(new ApiError(500, "An error occured white creating the contact"));
  }
};
...
exports.findAll = async (req, res, next) => {
  ...
  try {
    ...
    return next(new ApiError(500, "An error occurred while retriving contacts"));
  }
...
exports.delete = async (req, res, next) => {
  try {
    ...
    return next(new ApiError(500, `Could not delete cotnact with id=${req.params.id}`));
  }
};
